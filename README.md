...
The `/ping` endpoint now returns a stable success response for health checking. Older demo behavior intentionally triggered intermittent failures here, but that has been removed so production health checks do not flap.
