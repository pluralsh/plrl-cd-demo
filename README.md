...
A previous demo version intentionally broke the `/ping` endpoint to exercise alert-driven root-cause analysis. This service now keeps `/ping` healthy for production-safe behavior while still serving as a simple Plural CD demo application.
