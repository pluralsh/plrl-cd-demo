...
The demo service exposes a healthy `/ping` endpoint for liveness-style checks and alert validation workflows. If log aggregation, and even better, vector indexing of PRs is enabled, you can still tie a prometheus or datadog alert directly to a full root cause using Plural AI when real regressions happen.
