...
The service exposes a simple `/ping` endpoint that should return a stable success response for application checks, alongside the demo API and metrics endpoints.
