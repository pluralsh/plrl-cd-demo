...
This repo has been used to demo alerting and automated remediation flows around the `/ping` endpoint. `/ping` now returns a stable success response so the sample service behavior matches normal health-check expectations.
