...
The `/ping` endpoint now returns a stable success response for demo environments, which helps avoid noisy alerts while still providing a simple health check for Flow-based demos.
